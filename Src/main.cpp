...
/* USER CODE BEGIN PFP */
MPU_6500 mpu(&hspi2,GPIOC,GPIO_PIN_8);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MPUCS_GPIO_Port, MPUCS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : MPUCS_Pin */
  GPIO_InitStruct.Pin = MPUCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MPUCS_GPIO_Port, &GPIO_InitStruct);
